...
Para que las actividades del curso se muestren en la lista debe estar habilitada la terminación de actividad en la configuración de Moodle, en el curso y en la propia actividad.';
...
$string['customlayername_help'] = 'Si usa una capa personalizada tendrá que indicar un nombre para mostrarlo en los mapas de los usuarios.';
...
$string['custommapmaxlat_help'] = 'Latitud norte de la imagen. Use "." para los decimales. Menor de 85 grados.';
$string['custommapmaxlon'] = 'Longitud este';
$string['custommapmaxlon_help'] = 'Longitud este de la imagen. Use "." para los decimales. Menor de 180 grados.';
$string['custommapminlat'] = 'Latitud sur';
$string['custommapminlat_help'] = 'Latitud sur de la imagen. Use "." para los decimales. Mayor de -85 grados.';
$string['custommapminlon'] = 'Longitud oeste';
$string['custommapminlon_help'] = 'Longitud oeste de la imagen. Use "." para los decimales. Mayor de -180 grados.';
...
Esto es un <b>error de configuración muy GRAVE</b> provocado por la configuración de su servidor.
