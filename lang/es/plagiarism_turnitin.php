...
/**
 * Strings for component 'plagiarism_turnitin', language 'es', branch 'MOODLE_34_STABLE'
 *
...
$string['genspeednote'] = 'Nota: La generación del informe de originalidad para un reenvío puede demorarse 24 horas';
