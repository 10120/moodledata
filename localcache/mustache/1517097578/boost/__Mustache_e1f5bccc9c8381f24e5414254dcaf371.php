...
class __Mustache_e1f5bccc9c8381f24e5414254dcaf371 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                        <input style="display:inline-block;vertical-align: center;" type="checkbox" name="habeasdata">
';
        $buffer .= $indent . '                        <label style="display:inline-block;vertical-align: center; font-size: 7pt; width: 70%; " for="habeasdata">Acepto terminos y condiciones de la politica de privacidad</label>
';
