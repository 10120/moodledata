...
class __Mustache_edefe615fa2dae4d02804e586afc56f1 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                        <input style="display:inline-block;" type="checkbox" name="habeasdata">
';
        $buffer .= $indent . '                        <label style="display:inline-block; font-size: 7pt; width: 70%; " for="habeasdata">Acepto terminos y condiciones de la politica de privacidad</label>
';
