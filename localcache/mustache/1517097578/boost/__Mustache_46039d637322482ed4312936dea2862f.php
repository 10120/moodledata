...
class __Mustache_46039d637322482ed4312936dea2862f extends Mustache_Template
{
...
';
        $buffer .= $indent . '                        <label style="display:inline-block; font-size: 7pt; " for="habeasdata">Acepto terminos y condiciones de la politica de privacidad</label>
';
