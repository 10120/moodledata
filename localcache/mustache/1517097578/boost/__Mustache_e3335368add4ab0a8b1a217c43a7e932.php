...
class __Mustache_e3335368add4ab0a8b1a217c43a7e932 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                    <form>
';
        $buffer .= $indent . '                        <input type="text" name="nombre" placeholder="Nombre y Apellido">
';
        $buffer .= $indent . '                        <input type="text" name="Cedula" placeholder="Cédula">
';
        $buffer .= $indent . '                        <input type="email" name="email" placeholder="E-Mail">
';
        $buffer .= $indent . '                        <input type="password" name="password" placeholder="Contraseña">
';
        $buffer .= $indent . '                        <input type="password" name="password" placeholder="Confirmar Contraseña">
';
        $buffer .= $indent . '                        <input type="tel" name="telefono" placeholder="Celular">
';
