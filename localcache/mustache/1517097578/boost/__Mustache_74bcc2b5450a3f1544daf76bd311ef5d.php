...
class __Mustache_74bcc2b5450a3f1544daf76bd311ef5d extends Mustache_Template
{
...
';
        $buffer .= $indent . '                <h1 style="font-size: 16pt">Ingreso Estudiante</h1>
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                <div class="m-t-l">
';
        $buffer .= $indent . '                    <h1 style="font-size: 16pt">Registrate para adquirir Curso</h1>
';
        $buffer .= $indent . '                    <form>
';
        $buffer .= $indent . '                        <input class="form-control" type="text" name="nombre" placeholder="Nombre y Apellido">
';
        $buffer .= $indent . '                        <input class="form-control" type="text" name="Cedula" placeholder="Cédula">
';
        $buffer .= $indent . '                        <input class="form-control" type="email" name="email" placeholder="E-Mail">
';
        $buffer .= $indent . '                        <input class="form-control" type="password" name="password" placeholder="Contraseña">
';
        $buffer .= $indent . '                        <input class="form-control" type="password" name="password" placeholder="Confirmar Contraseña">
';
        $buffer .= $indent . '                        <input class="form-control" type="tel" name="telefono" placeholder="Celular">
';
        $buffer .= $indent . '                        <br>
';
        $buffer .= $indent . '                        <input style="display:inline-block;vertical-align:top;" type="checkbox" name="habeasdata">
';
        $buffer .= $indent . '                        <label style="display:inline-block;vertical-align:top; font-size: 7pt; width: 70%; " for="habeasdata">Acepto terminos y condiciones de la politica de privacidad</label>
';
        $buffer .= $indent . '                        <button class="btn btn-primary btn-block m-t-1" type="submit">enviar</button>
';
        $buffer .= $indent . '                    </form>
';
        $buffer .= $indent . '                </div>  
