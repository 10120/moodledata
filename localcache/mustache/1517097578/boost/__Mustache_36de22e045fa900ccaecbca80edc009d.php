...
class __Mustache_36de22e045fa900ccaecbca80edc009d extends Mustache_Template
{
...
';
        $buffer .= $indent . '                        <input style="display:inline-block;vertical-align:middle;" type="checkbox" name="habeasdata">
';
        $buffer .= $indent . '                        <label style="display:inline-block;vertical-align:middle; font-size: 7pt; width: 70%; " for="habeasdata">Acepto terminos y condiciones de la politica de privacidad</label>
';
