...
class __Mustache_af40b280d813175841b9c83d13a9d388 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                        <input type="checkbox" name="habeasdata">
';
        $buffer .= $indent . '                        <label for="habeasdata">Acepto terminos y condiciones de la politica de privacidad</label>
';
